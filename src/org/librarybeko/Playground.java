...
import org.librarybeko.entity.management.pr.Student;
...
//        Member member = new Student("Cemil Doe","adres",90500123L);
//        System.out.println(member.getRegistrationDate());
//        member.depositCash(10.00);
//        member.depositCash(10.00);
//        member.purchaseBook(Inventory.attilaIlhan.getBooks().get(0));
